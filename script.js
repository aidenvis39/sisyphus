...
비탈길을 내려가는 발걸음이 무겁다. 저 아래 평지에 돌이 보인다.`,
    choices: [
      ...
      { id: 'd', text: "이게 그냥 형벌일 리가 없는데. 신들이 뭔가 원하는 게 있을 거야. 아직 내가 모를 뿐." }
    ]
  },
...
숨을 고르다가 문득, 이상한 걸 느꼈다.`,
    choices: [
      { id: 'a', text: "내 발이 알아서 돌 쪽으로 걸어가고 있다. 생각보다 몸이 먼저 움직인다. 내가.. 움직인건가?" },
      { id: 'b', text: "다섯 번 다 달랐어. 어떨 때는 화났고, 어떨 때는 담담했고. 이 산이 스스로를 돌아보게 하는 건가." },
...
산 아래에서 돌과 마주 보고 서 있는데, 갑자기 웃음이 나왔다.`,
    choices: [
      ...
      { id: 'c', text: "결국 다 내가 한 짓 때문이긴 해. 신들한테 한 소리 하고 싶지만, 이 길로 이끈 건 나야." },
      { id: 'd', text: "누가 잘못했는지 이제 모르겠어. 그냥... 이렇게 된 거지. 선을 긋기엔 너무 복잡해." }
    ]
  },
...
저 위를 올려다본다. 오늘은 어떤 기분이지?`,
    choices: [
      { id: 'a', text: "입으로는 '내 선택'이라고 하는데, 속으론 아직도 '신들이 날 이렇게 만든 거야' 하고 있어." },
      { id: 'b', text: "오늘은 내 탓 같고, 어제는 남 탓 같고. 아직 모르겠어. 둘 다 진짜 같아." },
      { id: 'c', text: "억울한 건 맞는데... 그래도 이 길을 어떻게 걸어갈지는 내가 정하고 싶긴 해." }
    ]
  },
...
돌을 보다가, 내 얼굴이 비친 물웅덩이를 발견했다.`,
    choices: [
      ...
      { id: 'b', text: "힘든 건 힘든데, 그것보다 이 과정에서 내가 어떤 표정 짓는지가 궁금하네." },
      { id: 'c', text: "이 산에서 내가 어떻게 무너지고 일어서는지 실험해보고 싶어. 끝까지 가보고 싶어, 내가 어떤 사람인지." },
...
아무도 안 들을 때, 진짜 내 마음은 어디 있지?`,
    choices: [
      ...
      { id: 'c', text: "'신들 탓이야'는 그냥 습관처럼 하는 말이야. 사실은 이 형벌을 어떻게 대할지는 내가 정하고 있어." }
    ]
  },
...
제일 먼저 무뎌진 게 뭘까.`,
    choices: [
      { id: 'a', text: "끝이 없다는 두려움. 그렇지만 이제는 그냥 그래." },
...
내일도 오를까? 내일도, 모레도, 계속?`,
    choices: [
      ...
      { id: 'c', text: "받아들이되, 멈출 권리도 있다는 거 잊지 않을게. 포기하지 않음으로 나를 고통받게 하지는 않을 거야." }
    ]
  },
...
손에 쥔 돌이 차갑다. 오늘도 올릴까? 이걸 계속?`,
    choices: [
      ...
      { id: 'c', text: "부당한 건 맞아. 근데... 그 안에서 나의 삶을 찾아보고 싶어." }
    ]
  },
...
나는 어떤 쪽으로 기울고 싶을까.`,
    choices: [
      ...
      { id: 'b', text: "높이도 좋은데, 몸 부서질 것 같으면 나를 먼저 챙길 거야. 끊임없이 나를 죽이진 않아." },
      { id: 'c', text: "하나만 선택하기 싫어. 오르막도 쉼터도 다 머물거야. 오가면서 균형을 찾고 싶어." }
    ]
  },
